...
def create_equipment_sheet(writer):
    ...
    # 设备数据
    equipment_data = [
        # 设备编号, 设备名称, 班组, 每日工作小时, 每日工作分钟, 效率系数, 状态
        ['M01', '数控车床CK6140', '白班', 8, 480, 1.00, '可用'],
        ['M02', '数控车床CK6150', '白班', 8, 480, 1.00, '可用'],
        ['M03', '立式加工中心VMC850', '白班', 8, 480, 0.95, '可用'],
        ['M04', '摇臂钻床Z3050', '白班', 8, 480, 1.00, '可用'],
        ['M05', '台钻Z4125', '白班', 8, 480, 1.00, '可用'],
        ['M06', '外圆磨床M1432', '白班', 8, 480, 0.90, '可用'],
        ['M07', '攻丝机S4016', '白班', 8, 480, 1.00, '可用'],
        ['M08', '滚齿机Y3150E', '白班', 8, 480, 0.85, '可用'],
    ]
